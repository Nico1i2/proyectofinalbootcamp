...
class ProductLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_line" do
    assert_difference('ProductLine.count') do
      post product_lines_url, params: { product_line: { description: @product_line.description, name: @product_line.name, product_line_ID: @product_line.product_line_ID } }
    end
  ...
  test "should update product_line" do
    patch product_line_url(@product_line), params: { product_line: { description: @product_line.description, name: @product_line.name, product_line_ID: @product_line.product_line_ID } }
